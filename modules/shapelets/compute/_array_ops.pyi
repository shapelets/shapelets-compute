...
from .__basic_typing import ArrayLike, DataTypeLike, ShapeLike, Shape, _ScalarLike,_ComplexLike
from ._array_obj import ShapeletsArray
from . import _pygauss

AnyScalar = _ScalarLike
FloatOrComplex = _ComplexLike
...
def argmin(array_like: ArrayLike, dim: Optional[int] = None) -> Union[Tuple[int, FloatOrComplex], Tuple[ShapeletsArray, ShapeletsArray]]: ...
...
def corrcoef(a: ShapeletsArray, b: ShapeletsArray) -> FloatOrComplex: ...
...
def mean(a: ShapeletsArray, weights: Optional[ShapeletsArray] = None, dim: Optional[int] = None) -> Union[FloatOrComplex, ShapeletsArray]: ...

def median(a: ShapeletsArray, dim: Optional[int] = None) -> Union[FloatOrComplex, ShapeletsArray]: ...
...
def stdev(a: ShapeletsArray, dim: Optional[int] = None) -> Union[FloatOrComplex, ShapeletsArray]: ...
...
def var_p(a: ShapeletsArray, weights: Optional[ShapeletsArray] = None, dim: Optional[int] = None) -> Union[FloatOrComplex, ShapeletsArray]: ...

def var_s(a: ShapeletsArray, weights: Optional[ShapeletsArray] = None, dim: Optional[int] = None) -> Union[FloatOrComplex, ShapeletsArray]: ...
