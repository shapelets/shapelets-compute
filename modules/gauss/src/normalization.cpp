...
af::array gauss::normalization::maxMinNorm(const af::array &tss, double high, double low, double epsilon) {
...
af::array gauss::normalization::znorm(const af::array &tss, double epsilon) {
    auto mean = af::tile(af::mean(tss, 0), static_cast<unsigned int>(tss.dims(0)));
