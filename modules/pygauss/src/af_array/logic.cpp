...
void logic_bindings(py::module &m) {
    ...
    UNARY_TEMPLATE_FN(isnan, af_isnan, "Returns a boolean tensor where all infite positions are set to True")
    // isnat
    // isneginf
    // isposinf
    ...
    UNARY_TEMPLATE_FN(logical_not, af_not, "Performs element-wise logical complement.  The result is always a boolean tensor")
    // MISSING LOGICAL_XOR
    ...
    BINARY_TEMPLATE_FN(greater_equal, af_ge, "Element-wise greater than or equal test.  The result is always a boolean tensor")
    BINARY_TEMPLATE_FN(less, af_lt, "Element-wise less than test.  The result is always a boolean tensor")
    BINARY_TEMPLATE_FN(less_equal, af_le, "Element-wise less than or equal test.  The result is always a boolean tensor")
