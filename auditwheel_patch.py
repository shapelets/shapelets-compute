...
for p in POLICIES:
    ...
    # p['lib_whitelist'].append('libcufft.so.10.5.0.43')  # shapelets_compute.libs/libcufft-da2333af.so.10.5.0.43
    # p['lib_whitelist'].append('libcufft.so.10.5.0')  # shapelets_compute.libs/libcufft-da2333af.so.10.5.0.43
    # p['lib_whitelist'].append('libcufft.so.10.5')  # shapelets_compute.libs/libcufft-da2333af.so.10.5.0.43
